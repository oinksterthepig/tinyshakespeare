...
shakespeare = textgenrnn(weights_path = '4layerBidirectional_weights.hdf5', vocab_path = '4layerBidirectional_vocab.json', config_path = '4layerBidirectional_config.json')
